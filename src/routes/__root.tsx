...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Al-Islah Institute serves humanity through Islamic education, verified welfare support, and an online Quran & Islamic teaching academy. Learn Quran, Tafseer, Hadith and Hifz online with qualified teachers." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Al-Islah Institute — Islamic Welfare & Online Quran Academy" },
      { name: "twitter:description", content: "Al-Islah Institute serves humanity through Islamic education, verified welfare support, and an online Quran & Islamic teaching academy. Learn Quran, Tafseer, Hadith and Hifz online with qualified teachers." },
